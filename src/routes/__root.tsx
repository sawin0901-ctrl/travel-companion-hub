...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "JetSale — российский маркетплейс путешествий: авиабилеты, отели, апартаменты, аренда авто, трансферы и страховки. Цены в рублях." },
      { name: "keywords", content: "авиабилеты, отели, бронирование, квартиры посуточно, аренда авто, туры, путешествия, Россия" },
      { name: "author", content: "JetSale" },
      ...
      { property: "og:site_name", content: "JetSale" },
